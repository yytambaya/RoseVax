...
<div class="card card-outline card-primary">
    <div class="card-header d-flex">
        <h5 class="card-title col-auto flex-grow-1">Vaccination Schedule</h5>
        <div class="col-auto">
            ...
            <div class="row">
                <div class="col-6">
                    <dl>
                        ...
                        <dd class=""><?php echo isset($tracking_code) ? 'corona Virus' : '' ?></dd>
                        <dt class="text-muted">Vaccination Dose:</dt>
                        <dd class=""><?php echo isset($name) ? '2nd dose' : '2nd dose' ?></dd>
                        <dt class="text-muted">Vaccination location:</dt>
                        <dd class=""><?php echo isset($gender) ? 'Tudun Yola, kano' : '' ?></dd>
                ...
                <div class="col-6">
                    <dl>
                        ...
                        <dd class=""><?php echo isset($dob) ? date("M d, Y",strtotime($dob)) : '' ?></dd>
                        <dt class="text-muted">Time:</dt>
                        <dd class=""><?php echo isset($dob) ? '12:00 pm' : '' ?></dd>
