...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Schedule " ?> Vaccination</h3>
	</div>
	<div class="card-body">
		<form action="" id="history-form">
			...
			<div class="form-group row">
                <div class="col-md-6">
						...
						<div class="form-group">
							<label for="dob" class="control-label">Time</label>
							<input type="time" class="form-control form-control-sm rounded-0" id="dob" name="dob">
						</div>
					</div>


				<div class="col-md-6">
					<label for="vaccine_id">Vaccination Type</label>
			...
			<div class="form-group row">
				<div class="col-md-6">
					<div class="mb-2">
						<label for="vaccination_type" class="control-label">Vaccination Dose</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="history-form2">Schedule</button>
		<a class="btn btn-flat btn-default" href="?page=individual-schedules">Cancel</a>
	</div>
</div>
<script>
